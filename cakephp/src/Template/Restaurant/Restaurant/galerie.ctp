<section class="container-fluid" id="galerie">
    ...
    <section class="row">
        <?= $this->Html->image('placeholder/farm.jpg', ['class' => 'col-lg-5']) ?>
        <div class="col-lg-7">
            <header>
                <h2>La salle</h2>
            </header>
    ...
    <section class="row">
        ...
        <?= $this->Html->image('placeholder/architecture.jpg', ['class' => 'col-lg-5']) ?>
    </section>

    <section class="row">
        <?= $this->Html->image('placeholder/salt.jpg', ['class' => 'col-lg-5']) ?>
		<div class="col-lg-7">
            <header>
                <h2>Le grill</h2>
            </header>
